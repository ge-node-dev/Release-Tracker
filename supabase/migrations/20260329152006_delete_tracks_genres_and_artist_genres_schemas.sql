...
alter table "public"."artists_genres" drop constraint "artists_genres_artist_id_fkey";

alter table "public"."artists_genres" drop constraint "artists_genres_genre_id_fkey";
...
alter table "public"."artists_genres" drop constraint "artists_genres_pkey";

alter table "public"."track_genres" drop constraint "track_genres_pkey";

drop index if exists "public"."artists_genres_pkey";
